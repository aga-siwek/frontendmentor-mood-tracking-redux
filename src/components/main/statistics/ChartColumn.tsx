    ...
    <div className="flex flex-col gap-3">
      ...
      >
        ...
        >
          ...
          <div className="absolute lg:bottom-[10%] lg:left-1/2 -translate-x-[110%] whitespace-normal z-50 transition-opacity duration-300 lg:w-[219px] opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto group-active:opacity-100">
            <ColumnInfo
