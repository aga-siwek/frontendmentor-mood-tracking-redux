...
function AverageMood() {
  ...
  const feelSwitch = () => {
    switch (averageMood) {
      case 2:
        return (
          <p className="text-neutral-1 font-semibold text-[24px] leading-[1.4]">
            Very Happy
          </p>
        );
      case 1:
  ...
  const feelIconChange = () => {
    if (averageMood === undefined) {
      return null;
    } else if (prevAverageMood === undefined) {
  ...
  return (
    <div className="flex flex-col gap-3 w-full">
      <div className="flex gap-1 min-5">
        <p className="text-neutral-1 font-semibold text-[18px] leading-[1.4]">
          Average Mood
        </p>
        <p className="text-neutral-2 font-light text-[18px] leading-[1.4]">
          (Last 5 check-ins)
        </p>
      </div>
