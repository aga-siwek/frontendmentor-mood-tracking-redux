                            ...
                            <Controller
                                ...
                                render={({ field, fieldState }) => (
                                    <Field data-invalid={fieldState.invalid}>
                                        <FieldLabel
                                            htmlFor="form-rhf-input-veryHappy"
                                            className="text-start font-light text-[18px] leading-[1.4] tracking-[-0.3px]"
                                        >
                                            <div className="h-5 w-5 border border-solid border-accent-3 rounded-full"></div>
                                            <div className="text-[24px] leading-[1.4] font-semibold text-neutral-1">Very Happy</div>
                                        </FieldLabel>
                                        <Input
                                            {...field}
                                            id="form-rhf-input-veryHappy"
                                            type="radio"
                                            name="mood"
                                            value="2"
                                            aria-invalid={fieldState.invalid}
                                            autoComplete="veryHappy"
                                            className="font-light ext-[18px] leading-[1.4] tracking-[-0.3px] hidden"
                                        />
                                        {fieldState.invalid && (
